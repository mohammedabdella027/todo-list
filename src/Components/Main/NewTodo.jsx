...
function NewTodo({darkMode, setNewTodo}) {
    return (
        ...
        <div className={`${darkMode ? 'bg-[#252525]' : 'bg-white'} w-90 sm:w-130 h-72 border rounded-2xl relative m-auto`}>
            ...
            <button className='font-medium font-kanit text-[18px] text-center w-24.5 h-9.5 border rounded-[5px] absolute bottom-2.5 right-5.5 bg-[#6C63FF] hover:bg-[#5850DD] text-white'>Apply</button>
